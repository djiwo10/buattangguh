...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.ViewHolder> {
    ...
    List<DataBaseModel.DatabaseModel> modelDatabase;
    Context mContext;

    public HistoryAdapter(Context context, List<DataBaseModel.DatabaseModel> modelInputList) {
        this.mContext = context;
        this.modelDatabase = modelInputList;
    }

    //untuk set data ke menu view
    public void setDataAdapter(List<DataBaseModel.DatabaseModel> items) {
        modelDatabase.clear();
    ...
    public void onBindViewHolder(HistoryAdapter.ViewHolder holder, int position) {
        final DataBaseModel.DatabaseModel data = modelDatabase.get(position);
    ...
    public void restoreItem(DataBaseModel.DatabaseModel databaseModel, int position) {
        modelDatabase.add(position, databaseModel);
        notifyItemInserted(position);
    }

    public List<DataBaseModel.DatabaseModel> getData() {
