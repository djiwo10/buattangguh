...
public class HistoryOrderActivity extends AppCompatActivity {
    ...
    List<DataBaseModel.DatabaseModel> modelDatabaseList = new ArrayList<>();
    ...
    private void setViewModel() {
        ...
        historyViewModel.getDataList().observe(this, new Observer<List<DataBaseModel.DatabaseModel>>() {
            @Override
            public void onChanged(List<DataBaseModel.DatabaseModel> modelDatabases) {
        ...
        ItemTouchHelper.SimpleCallback simpleCallback =
                new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.START | ItemTouchHelper.END) {
                    ...
                    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                        ...
                        final DataBaseModel.DatabaseModel databaseModel = historyAdapter.getData().get(position);
                        ...
                        alertDialogBuilder.setPositiveButton("Ya, Hapus", (dialogInterface, i) -> {
                            ...
                            Toast.makeText(HistoryOrderActivity.this, "Data yang dipilih sudah dihapus", Toast.LENGTH_SHORT).show();
                        });
